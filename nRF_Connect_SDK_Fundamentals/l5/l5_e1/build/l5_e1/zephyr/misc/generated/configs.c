...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_OFFSET, 0x8a000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_BASE_ADDRESS, 0x20014000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_GPIOTE20_SECURE_CHANNELS_MASK, 0x00000000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_GPIOTE30_SECURE_CHANNELS_MASK, 0x00000000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_20_NRF_ASYNC_LOW_POWER, 1);
